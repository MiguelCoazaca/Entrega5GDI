...
<tr><td colspan="17"><label>Consulta 10: Lista de todos los clientes jurídicos. En la Figura 41 se muestra una lista con todos los clientes jurídicos, tanto
destinatarios como remitentes y el número de RUC de cada uno. Para realizar la consulta se unieron 2 consultas mediante el
...
tipo_dest sea igual a “RUC”, la segunda consulta es similar a la primera pero es vez de usar la tabla Destinatario, usamos la
tabla Remitente.
<br><br>
 ...
 <tr>
    <td><label>Cliente Juridico: </label></td>
    <td><label>Numero RUC: </label></td>
</tr>

<?php 
    $sql="call sp_lista_clientes_juridicos;
...
?>
<tr> 
	<td><?php echo $mostrar['Cliente Juridico'] ?>
    <td><?php echo $mostrar['Numero RUC'] ?>
