...
<tr><td colspan="17"><label>Consulta 5: Ranking de las 5 rutas más usadas. En la Figura 36 se muestra una lista con las 5 rutas más usadas junto con la
cantidad de veces que fueron utilizadas. Para realizar la consulta se utilizaron los campos nombre_ruta de la tabla Ruta y
...
para agrupar los registros en base al campo codigo_ruta, ORDER BY y DESC para ordenar los registros de forma descendente
y LIMIT 5 para que solo muestre los 5 primeros resultados.
...
<br><br>
 ...
 <tr>
    <td><label>Nombre Ruta: </label></td>
    <td><label>Veces Usada: </label></td>
</tr>

<?php 
    $sql="call sp_lista_rutas_mas_usadas;
