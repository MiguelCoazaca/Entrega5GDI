...
<tr><td colspan="17"><label>Consulta 3: Encomiendas asignadas a una ruta de envío. En la Figura 34 se muestra una lista con toda la información de las
encomiendas asignadas a una ruta específica, dicha ruta se filtra de acuerdo a su nombre, fecha y hora de salida. Para realizar la
consulta se utilizaron los campos codigo_enc y descripción de la tabla Encomienda, nombre_rem y telf_rem de la tabla
Remitente, nombre_dest y telf_dest de la tabla Destinatario. Las tablas Ruta, Remitente y Destinatario se unen a la tabla
Encomienda mediante codigo_ruta, codigo_rem y codigo_dest respectivamente. Finalmente, se específica el nombre fecha y
hora de salida de la ruta que se desea consultar.
...
<br><br>
 ...
 <tr>
    <td><label>Codigo Encomienda: </label></td>
    <td><label>Descripcion: </label></td>
    <td><label>Nombre Remitente: </label></td>
    <td><label>Telefono Remitente: </label></td>
    <td><label>Nombre Destinatario: </label></td>
    <td><label>Telefono Destinatario: </label></td>
</tr>

<?php 
    $sql="call sp_lista_guia_remision_remitente_destinatario_filtro_ruta;
    ";
